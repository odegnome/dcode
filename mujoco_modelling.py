...
class Arm(object):
    def __init__(self,name):
        ...
        self.upper_arm = self.mjcf_model.worldbody.add(
            'body',name='upper_arm'
        )
        self.shoulder = self.upper_arm.add(
        ...
        self.forearm = self.upper_arm.add(
            'body',name='forearm',pos=[0,0,-0.3]
        )
        self.elbow = self.forearm.add(
...
class UpperBody(object):
    def __init__(self):
        self.mjcf_model = mjcf.RootElement(model='test')
